 ...
 */
@Entity
@Table(name = "vw_resposta_1a_correcao")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "VwResposta1aCorrecao.findAll", query = "SELECT v FROM VwResposta1aCorrecao v"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByIdResposta", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.idResposta = :idResposta"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByIdDisciplina", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.idDisciplina = :idDisciplina"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByCdSerial", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.cdSerial = :cdSerial"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByNrQuestao", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.nrQuestao = :nrQuestao"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByIdProcesso", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.idProcesso = :idProcesso"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByNrNotaFinal", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.nrNotaFinal = :nrNotaFinal"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByFlDiscrepancia", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.flDiscrepancia = :flDiscrepancia"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByFlDiscrepanciaCorrigida", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.flDiscrepanciaCorrigida = :flDiscrepanciaCorrigida"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByFlCorrigida", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.flCorrigida = :flCorrigida"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByIdColaboradorAtual", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.idColaboradorAtual = :idColaboradorAtual"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByFlCorrigindo", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.flCorrigindo = :flCorrigindo"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByIdCurso", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.idCurso = :idCurso"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByDtInsercaoResposta", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.dtInsercaoResposta = :dtInsercaoResposta"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByDtInsercao", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.dtInsercao = :dtInsercao"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByFlRespostaComErro", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.flRespostaComErro = :flRespostaComErro"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByFlPrimeiraCorrecao", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.flPrimeiraCorrecao = :flPrimeiraCorrecao"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByFlSegundaCorrecao", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.flSegundaCorrecao = :flSegundaCorrecao"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByIdCorrecao", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.idCorrecao = :idCorrecao"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByIdColaborador", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.idColaborador = :idColaborador"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByNrNota", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.nrNota = :nrNota"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByDtAtualizacao", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.dtAtualizacao = :dtAtualizacao"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByIdTipoCorrecao", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.idTipoCorrecao = :idTipoCorrecao"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByFlSucesso", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.flSucesso = :flSucesso"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByDtInsercaoCorrecao", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.dtInsercaoCorrecao = :dtInsercaoCorrecao"),
    @NamedQuery(name = "VwResposta1aCorrecao.findByIdInscricao", query = "SELECT v FROM VwResposta1aCorrecao v WHERE v.idInscricao = :idInscricao")})
public class VwResposta1aCorrecao implements Serializable {
