...
public class GenericDAO<Obj> {
    ...
    public Session getSessao() {
        /*
        if(!this.sessao.isConnected() || !this.sessao.isOpen()){
            ...
            if (met[k].getName().startsWith("get")) {
                ...
                try {
                    ...
                    if (valor != null) {
                        ...
                        if (met[k].getName().contains("nm")) { //Ifs separados para o caso de fazer alguma operação específica para cada tipo de dado, como conversão, por exemplo.
